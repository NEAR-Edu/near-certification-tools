  ...
  return (
    <footer className="bg-gray-100 shadow-[1px_1px_10px_1px_rgba(0,0,0,0.2)]">
      <div className="mx-auto px-4 flex items-center justify-center">
        ...
        <FooterSocials />
        <a href="https://jobs.near.university/" target="_blank" rel="noopener noreferrer" className="text-base font-medium text-gray-500 hover:text-gray-900 pr-3">
          Jobs
        </a>
        <a href="https://forms.gle/EKpNXNGuwLvuribn8" target="_blank" rel="noopener noreferrer" className="text-base font-medium text-gray-500 hover:text-gray-900 pr-3">
          Feedback
        </a>
      </div>
    </footer>
