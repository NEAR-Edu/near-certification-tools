...
const navigation = {
  main: [
    { name: 'Discord', href: 'https://discord.gg/k4pxafjMWA' },
    { name: 'Youtube', href: 'https://www.youtube.com/c/NEARProtocol' },
    { name: 'Jobs', href: 'https://jobs.near.university/' },
  ],
  social: [
    {
      name: 'Instagram',
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/NEARedu?s=20',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/NEAR-Edu',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
